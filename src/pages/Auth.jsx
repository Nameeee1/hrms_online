...
import { StyledWrapper } from '../styles/AuthStyles';
    ...
    try {
      if (isLogin) {
        ...
        if (userDoc.exists()) {
          ...
          if (userData.permissions?.account?.login === false) {
            // If login is disabled, sign the user out and show error
            await signOut(auth);
            throw new Error('Your account has been deactivated. Please contact HR.');
          }
          
          // If we get here, login is allowed
        ...
        // Set default permissions with login enabled
    ...
    <StyledWrapper>
      ...
      <form className="form_container" onSubmit={handleSubmit}>
        <div className="logo_container">
          <img src={loginLogo} alt="Logo" className="logo_image" />
        </div>
        <div className="title_container">
          <p className="title">HYACINTH</p>
          <span className="subtitle">Human Resource Management System</span>
        </div>
        ...
        {!isLogin && (
          <div className="input_container">
            <label className="input_label" htmlFor="fullName">Full Name</label>
            <svg fill="none" viewBox="0 0 24 24" height={24} width={24} xmlns="http://www.w3.org/2000/svg" className="icon">
              <path strokeLinejoin="round" strokeLinecap="round" strokeWidth="1.5" stroke="#141B34" d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z" />
              <path strokeLinejoin="round" strokeWidth="1.5" stroke="#141B34" d="M20.5899 22C20.5899 18.13 16.7399 15 11.9999 15C7.25991 15 3.40991 18.13 3.40991 22" />
            </svg>
            <input 
              value={fullName}
